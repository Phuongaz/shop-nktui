  ...
  <div class="card md:card-side bordered">
    ...
    <div class="card-body">
      ...
      <div class="card-actions">
        <div class="btn-group">
          <button class="btn glass bg-pastel-red hover:bg-pastel-pink btn-primary" @click="cartStore.remove(cartProduct.id)">
            -
          </button>
          <button class="btn btn-ghost no-animation">
            {{ cartProduct.quantity }}
          </button>
          <button class="btn glass bg-pastel-red hover:bg-pastel-pink btn-primary" @click="cartStore.add(cartProduct.id)">
            +
          </button>
        </div>
      </div>
